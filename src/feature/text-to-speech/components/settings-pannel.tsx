...
import { SettingsPanelHistory } from "@/src/feature/text-to-speech/components/settings-panel-history";
import { SettingsPanelSettings } from "@/src/feature/text-to-speech/components/settings-panel-settings";
